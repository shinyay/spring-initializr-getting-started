...
|                                      |                                                              |                               |
| azure-active-directory               | Spring Security integration with Azure Active Directory for  |                               |
|                                      | authentication.                                              |                               |
|                                      |                                                              |                               |
| azure-keyvault-secrets               | Manage application secrets and keys.                         |                               |
|                                      |                                                              |                               |
| azure-storage                        | Azure Storage service integration.                           |                               |
|                                      |                                                              |                               |
| azure-support                        | Auto-configuration for Azure Services (Service Bus, Storage, |                               |
...
|                                      | actual data store.                                           |                               |
|                                      |                                                              |                               |
| camel                                | Apache Camel lets you create the Enterprise Integration      | >=2.0.0.M1 and <2.2.0.M1      |
...
|                                      | HashiCorp Vault.                                             |                               |
|                                      |                                                              |                               |
| cloud-connectors                     | Simplifies the process of connecting to services and gaining |                               |
...
|                                      |                                                              |                               |
| cloud-gcp                            | Contains auto-configuration support for every Spring Cloud   |                               |
|                                      | GCP integration. Most of the auto-configuration code is only |                               |
|                                      | enabled if other dependencies are added to the classpath.    |                               |
|                                      |                                                              |                               |
| cloud-gcp-pubsub                     | Adds the GCP Support entry and all the required dependencies |                               |
|                                      | so that the Google Cloud Pub/Sub integration work out of the |                               |
|                                      | box.                                                         |                               |
|                                      |                                                              |                               |
| cloud-gcp-storage                    | Adds the GCP Support entry and all the required dependencies |                               |
...
|                                      | Netflix Zuul.                                                |                               |
|                                      |                                                              |                               |
| codecentric-spring-boot-admin-client | Required for your application to register with a Spring Boot | >=2.0.0.RELEASE and <2.2.0.M1 |
|                                      | Admin Server instance.                                       |                               |
|                                      |                                                              |                               |
| codecentric-spring-boot-admin-server | A community project to manage and monitor your Spring Boot   | >=2.0.0.RELEASE and <2.2.0.M1 |
...
|                                      |                                                              |                               |
| scs-circuit-breaker                  | Hystrix circuit breaker client on Pivotal Cloud Foundry.     |                               |
|                                      |                                                              |                               |
| scs-config-client                    | Config client on Pivotal Cloud Foundry.                      |                               |
|                                      |                                                              |                               |
| scs-service-registry                 | Eureka service discovery client on Pivotal Cloud Foundry.    |                               |
|                                      |                                                              |                               |
